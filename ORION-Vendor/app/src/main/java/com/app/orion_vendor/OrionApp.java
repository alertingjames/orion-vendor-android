...
public class OrionApp extends Application {
    public static final String TAG = OrionApp.class.getSimpleName();

    private String m_gsmToken = "";

    private static final String LOG_TAG = "CrashCatch";

    private static OrionApp _instance;

    public static OrionApp getApplication() {
        return _instance;
    }
    ...
    public static synchronized OrionApp getInstance(){
